...
public class PropertiesFrame extends JFrame {
	...
	private JComboBox<ContextFreeGrammar> cbPrRL1;
	...
	private void initialize() {
		...
		cbPrRL1 = new JComboBox<ContextFreeGrammar>();
		...
		cbPrProperties.addItem("Is Factored?");
		cbPrProperties.addItem("Has Left Recursion?");
		...
		btnPrVerify.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ContextFreeGrammar cfg = (ContextFreeGrammar) cbPrRL1.getSelectedItem();
